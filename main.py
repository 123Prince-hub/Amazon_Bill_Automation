...
BANDCAMP_FRONTPAGE='https:/www.google.com/'
...
class BandLeader():
    ...
    def catalogue_pages(self):
        ...
        '''
        print('PAGES')
        for e in self.driver.find_elements_by_class_name('item-page'):
            print(e.text)
        print('')
    ...
    def more_tracks(self,page='next'):
        ...
        next_btn = [e for e in self.driver.find_elements_by_class_name('item-page')
